    ...
    <div className="legal-section-title">
      ...
      <div className="legal-text-content">
        ...
        <p className="legal-description">
          Welcome to Health Connect, your trusted online healthcare platform. Our
        ...
        <p className="legal-description">
          When using Health Connect, you agree to our Terms of Service. This
        ...
        <p className="legal-description">
          Health Connect is designed to simplify healthcare access. You can choose
